...
3. Expand integrity diagnostics coverage beyond lightweight stale-artifact counters.
4. Add guided repair and setup workflows on top of the new diagnostics commands.
